...
下载前，请确认下载机器可以访问https://github.com.
    ...
    ```bash
    $ <copy> curl -o cluster-autoscaler.yaml https://raw.githubusercontent.com/nengbai/oke-dashboard/main/cluster-autoscaler/cluster-autoscaler.yaml
    curl -o nginx.yaml https://raw.githubusercontent.com/nengbai/oke-dashboard/main/cluster-autoscaler/nginx.yaml
    </copy>
    ```
